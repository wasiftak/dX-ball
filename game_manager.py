...
class GameManager:
    ...
    def reset_game(self):
        ...
        self.level = 1
        self.hits_this_level = 0 # <-- THIS WAS THE MISSING LINE
    ...
    # Draws the score, lives, level, and timers
    def draw_ui(self, frame):
        ...
        cv2.putText(frame, effect_text, config.POWERUP_TIMER_POSITION, config.UI_FONT, 1.0, config.UI_COLOR, config.UI_FONT_THICKNESS)

    # --- Collision and Game Rule Logic ---
    ...
    def deactivate_effect(self, effect_type):
        ...
        if effect_type == "wide_paddle" or effect_type == "shrink_paddle":
